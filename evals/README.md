...
| `vocalize` | `letter_vowel`, `letter_dagesh`, `shin_dot`, `qamats_qatan_recall`, `word_exact` and `skeleton_kept`, Nakdimon and DICTA's menaked against the modern third of DICTA's diacritization test corpora | `scripts/measure_pointing.py` (targum-internal#148) |
